        ...
        <table className="w-full text-xs text-center">
          <thead className="">
            <tr className="bg-gray-100">
              <th className=" p-1 text-left !align-top leading-none font-semibold border-black border-b w-[98px]">
                <div className="flex justify-center items-start leading-normal pb-1 min-h-[20px] text-start w-full">
                  {" "}
                  Box No{" "}
                </div>
              </th>
              <th className="border-l !align-top leading-none border-black p-1 text-left font-semibold">
                <div className="flex justify-center items-start">
                  Description{" "}
                </div>
              </th>
              <th className="border-l !align-top leading-none border-black p-1 text-center font-semibold">
                <div className="flex justify-center items-start"> HSN</div>
              </th>
              <th className="border-l !align-top leading-none border-black p-1 text-center font-semibold">
                <div className="flex justify-center items-start">Quantity </div>
              </th>
              <th className="border-l !align-top leading-none border-black p-1 text-center font-semibold">
                <div className="flex justify-center items-start">Rates </div>
              </th>
              <th className="border-l !align-top leading-none border-black p-1 text-center font-semibold">
          ...
          <tbody className="border-b border-black">
            <tr className="border-y border-black">
              {/* <td className=" border-black p-1">{invoiceData?.boxes}</td> */}
            </tr>
            {invoiceData?.items?.map((item, idx) => {
              const prevBoxNo = invoiceData.items[idx - 1]?.boxNo;
              const showBoxNo = item.boxNo !== prevBoxNo; // show only when new box starts

              return (
                <tr key={idx} className="pb-2">
                  <td className=" border-black p-1 pb-3 text-center align-top leading-none">
                    {showBoxNo ? item.boxNo : ""}
                  </td>
                  <td className="border-l border-black p-1 pb-3 text-left align-top leading-none">
                    {item.description}
                  </td>
                  <td className="border-l border-black p-1 pb-3 text-center align-top leading-none">
                    {item.hsn}
                  </td>
                  <td className="border-l border-black p-1 pb-3 text-center align-top leading-none">
                    {item.quantity}
