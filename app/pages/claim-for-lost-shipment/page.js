...
import ClaimForLostShipmentSummary from "../claim-for-lost-ss/page";

const ClaimForLostShipment = () => {
  ...
  return (
    <div className="p-10">
      <div className="space-y-4">
        <Heading
          title={`Claim For Lost Shipment - CR`}
          fullscreenBtn
...
export default ClaimForLostShipment;
